...
<script lang="ts">
  ...
  name: "Noah Workman",
  role: "Co-Founder & CEO",
  image: "/generated/Noah-Workman.jpg"
};
</script>
...
<section bind:this={sectionRef} {...props}>
	<div class="section-px section-py container mx-auto">
		<div class="relative mx-auto grid max-w-2xl place-items-center gap-16">
          ...
          text={`"We're not here to make more content. We're here to help teams use the good stuff they’ve already paid for—and finally get it out the door."`}
        />
